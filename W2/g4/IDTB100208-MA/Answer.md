...
Answer: Because it make difficult-to-read code with many conditional checks,making it harder to keep track of all the routes, and make it hard to maintain.
