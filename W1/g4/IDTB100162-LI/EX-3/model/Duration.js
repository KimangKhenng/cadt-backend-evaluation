...
export class Duration {
    ...
    // YOUR COMMENT
    /**
     * Return a new Duration by subtracting another duration.
     * @param {Duration} other - Another duration to subtract.
     * @returns {Duration} A new Duration representing the subtracted duration
     */
    minus = (other) => {
        // YOUR CODE
        return new Duration(this._totalSeconds - other._totalSeconds);
    ...
    toString = () => {
        // YOUR CODE
        let minute = Math.floor(this._totalSeconds / 60);
        let second = Math.floor(this._totalSeconds % 60);
