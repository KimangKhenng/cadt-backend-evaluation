...
export class RaceResultsService {
  ...
  getTimeForParticipant(participantId, sport) {
       // TODO
       const result = this._raceResults.find(result => result.participantId === participantId && result.sport === sport);
  ...
  getTotalTimeForParticipant(participantId) {
        // TODO
        const participantResults = this._raceResults.filter(result => result.participantId === participantId);
