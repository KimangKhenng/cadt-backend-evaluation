...
console.log(raceResultService.getTotalTimeForParticipant("participant2").toString());       // Expected : 4m 15s  
console.log(raceResultService.getTotalTimeForParticipant("participant3").toString());       // Expected : 4m 15s  
