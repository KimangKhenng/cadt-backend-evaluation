...
export class Duration {
    ...
    /**
     * Creates a new Duration from an object containing `_totalSeconds`.
     * @param {object} timeObj - An object containing `_totalSeconds`.
     * @returns {Duration} A new Duration instance.
     */
    static fromString(timeObj) {
        if (timeObj && typeof timeObj._totalSeconds === "number") {
            return new Duration(timeObj._totalSeconds);
        }
